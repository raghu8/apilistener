package com.raghu.stockticker.endpointlistener;
...
public class ReadAlphaAdvantageApi {
	...
	public String retrivingStockPrices(String stockSymbol) {
		...
		try {
			...
			URL url = new URL("https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=" + stockSymbol
					+ "&interval=30min&outputsize=compact&apikey=VH6I5JD3Y9KYWRFH");
